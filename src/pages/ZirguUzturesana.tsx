...
import { ChevronRight, Home, Building2, Users, Shield, Heart, CheckCircle2, MapPin, Phone, Mail, Star, User, CalendarClock, X } from "lucide-react";
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-3">
                  ...
                  icon: MapPin
                }].map((item, i) => <div key={i} className="flex items-start gap-3 p-3 rounded-lg hover:bg-neutral-50 transition-colors">
          ...
          <div className="w-full max-w-3xl grid md:grid-cols-2 bg-white rounded-2xl overflow-hidden shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-6 md:p-8">
              ...
              {!sent ? <form className="grid gap-4" onSubmit={onSubmit}>
                  ...
                  <button 
                    type="submit" 
                    className="mt-2 inline-flex items-center justify-center rounded-xl bg-primary text-white px-4 py-2.5 font-medium 
                               transition-all duration-300 hover:bg-primary-700 hover:scale-105"
                  >
                    Nosūtīt
                  </button>
