    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        ...
        <section className="mb-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
            ...
            <div className="relative h-80 rounded-xl overflow-hidden">
              <img 
                src={ridingLessonsImage} 
                alt="Individuālie jāšanas treniņi" 
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {subscriptions.map((sub, index) => (
              <div key={index} className={`glass-card p-6 hover-lift ${index === 3 ? 'border-2 border-primary' : ''}`}>
                {index === 3 && (
        ...
        <section className="mb-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
            <div className="relative h-80 rounded-xl overflow-hidden order-2 lg:order-1">
              <img 
                src={excursionsImage} 
                alt="Ekskursijas ar zirgu barošanu" 
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
        ...
        <section className="text-center bg-primary/5 rounded-2xl p-12">
          <h2 className="text-section mb-6 text-text">
            Vai jums ir jautājumi par cenām?
          </h2>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Mūsu komanda ar prieku palīdzēs izvēlēties piemērotāko risinājumu 
            jūsu vajadzībām un atbildēs uz visiem jautājumiem.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="tel:+37127234567" 
              className="btn-velvet inline-flex items-center justify-center"
            >
              Zvanīt: +371 27 234 567
            </a>
            <a 
              href="mailto:info@jjs.lv" 
              className="btn-outline-velvet inline-flex items-center justify-center"
            >
              Rakstīt e-pastu
            </a>
          </div>
