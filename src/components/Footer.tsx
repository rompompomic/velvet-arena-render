  ...
  return (
    <footer className="bg-text text-white">
      <div className="container mx-auto px-4 max-w-7xl">
        {/* Main Footer Content */}
        <div className="py-16">
          {/* Универсальная структура: мобильный / планшет – колонками (grid), десктоп – flex со средними колонками по центру */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:hidden">
            {/* Повторяем те же 4 колонки для мобильной/планшетной версии */}
            {/* 1 */}
            <div className="max-w-md">
              <div className="mb-6">
                <h3 className="text-2xl font-semibold mb-4 whitespace-nowrap">Latvian Horses</h3>
                <p className="text-white/80 leading-relaxed max-w-md">Vieta, kur cilvēki satiekas ar zirgiem. Profesionālas apmācības, pasākumi un atpūta harmonijā ar dabu.</p>
              </div>
              <div className="space-y-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-white/90">“Zustrenes”, Inčukalns, LV-2141, Latvija<br /></span>
                </div>
              </div>
            </div>
            {/* 2 */}
            ...
            <div className="min-w-0">
              ...
              <a href="/lv/davanu-kartes/" className="inline-block px-4 py-2 bg-primary rounded-lg text-white hover:bg-primary-700 transition-colors duration-300 text-center font-medium whitespace-nowrap">Pirkt karti</a>
              <p className="text-sm text-white/70 mt-2">Derīga 12 mēnešus • Elektroniska piegāde</p>
            </div>
          </div>

          {/* Десктопная версия (без дублирования логики позиционирования для крайних колонок) */}
          <div className="hidden lg:flex w-full items-start">
            ...
            {/* Центральные две колонки упакованы вместе и центрированы */}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="#" className="text-white/70 hover:text-white transition-all duration-300" aria-label="Instagram" title="Instagram">
                <svg className="w-5 h-5 block" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.366.062 2.633.35 3.608 1.326.975.975 1.264 2.242 1.326 3.608.058 1.266.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.062 1.366-.35 2.633-1.326 3.608-.975.975-2.242 1.264-3.608 1.326-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-1.366-.062-2.633-.35-3.608-1.326-.975-.975-1.264-2.242-1.326-3.608C2.175 15.584 2.163 15.204 2.163 12s.012-3.584.07-4.85c.062-1.366.35-2.633 1.326-3.608C4.534 2.567 5.801 2.279 7.167 2.217 8.433 2.159 8.813 2.163 12 2.163zm0 1.622c-3.142 0-3.507.012-4.74.069-1.02.047-1.574.216-1.942.364-.489.19-.838.418-1.205.785-.367.367-.595.716-.785 1.205-.148.368-.317.922-.364 1.942-.057 1.233-.069 1.598-.069 4.74s.012 3.507.069 4.74c.047 1.02.216 1.574.364 1.942.19.489.418.838.785 1.205.367.367.716.595 1.205.785.368.148.922.317 1.942.364 1.233.057 1.598.069 4.74.069s3.507-.012 4.74-.069c1.02-.047 1.574-.216 1.942-.364.489-.19.838-.418 1.205-.785.367-.367.595-.716.785-1.205.148-.368.317-.922.364-1.942.057-1.233.069-1.598.069-4.74s-.012-3.507-.069-4.74c-.047-1.02-.216-1.574-.364-1.942-.19-.489-.418-.838-.785-1.205a3.37 3.37 0 0 0-1.205-.785c-.368-.148-.922-.317-1.942-.364-1.233-.057-1.598-.069-4.74-.069zm0 3.915a5.3 5.3 0 1 1 0 10.6 5.3 5.3 0 0 1 0-10.6zm0 1.8a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7zm5.7-2.047a1.237 1.237 0 1 1 0 2.475 1.237 1.237 0 0 1 0-2.475z" />
                </svg>
              </a>
              <a href="#" className="text-white/70 hover:text-white transition-all duration-300" aria-label="TikTok" title="TikTok">
                <svg className="w-5 h-5 block" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M12.681 0h3.027a6.88 6.88 0 0 0 .112 1.273c.275 1.471.97 2.73 2.2 3.655 1.28.965 2.743 1.32 4.33 1.392v3.106c-1.61.065-3.145-.24-4.63-.934-.69-.325-1.31-.748-1.972-1.127l-.022 8.31c0 1.33-.272 2.592-.902 3.76-1.198 2.215-3.075 3.57-5.55 3.88-1.87.236-3.62-.138-5.19-1.23-1.822-1.274-2.89-3.008-3.188-5.175-.33-2.42.334-4.56 2.003-6.39 1.43-1.574 3.247-2.43 5.37-2.61.29-.025.585-.03.912-.043v3.22c-.12.017-.242.027-.362.05-1.217.238-2.187.82-2.83 1.9-.97 1.61-.76 3.68.51 5.02.65.67 1.45 1.06 2.38 1.176 1.92.24 3.69-.86 4.17-2.676.09-.35.13-.72.133-1.085l.01-15.7z" />
                </svg>
              </a>
            </div>
          </div>
