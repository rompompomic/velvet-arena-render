          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="min-w-0">
              ...
              <a
                ...
                className="inline-block px-4 py-2 bg-primary rounded-lg text-white hover:bg-primary-700 transition-colors duration-300 text-center font-medium whitespace-nowrap"
              >
                Pirkt karti
              </a>
