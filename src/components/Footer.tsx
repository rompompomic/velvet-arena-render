      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-lg font-semibold mb-6">Ātrās saites</h4>
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                <a href="/lv/davanu-kartes/" className="block px-4 py-2 bg-primary rounded-lg text-white hover:bg-primary-700 transition-colors duration-300 text-center font-medium">
                  Pirkt karti
                </a>
                <p className="text-sm text-white/70">
                  Derīga 12 mēnešus<br />
                  Elektroniska piegāde
                </p>
              </div>

              <h4 className="text-lg font-semibold mb-4">Juridiskā informācija</h4>
              <nav className="space-y-2">
                {legalLinks.map(link => <a key={link.name} href={link.href} className="block text-sm text-white/70 hover:text-white/90 transition-colors duration-300">
                    {link.name}
                  </a>)}
              </nav>
            </div>
