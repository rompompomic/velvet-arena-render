      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:hidden">
            ...
            <div className="min-w-0">
              ...
              <nav className="space-y-3">
                {quickLinks.map((l) => (
                  <a key={l.name} href={l.href} className="block text-white/80 hover:text-white transition-colors duration-300">
                    {l.name}
                  </a>
                ))}
              </nav>
            ...
            <div className="min-w-0 text-center">
              ...
              {/* Узкая и центрированная на мобиле */}
              <a
                href="/lv/davanu-kartes/"
                className="inline-flex w-full max-w-[220px] justify-center
                           px-5 py-2.5 bg-primary rounded-lg text-white font-medium
                           hover:bg-primary-700 transition-colors duration-300 whitespace-nowrap
                           mx-auto sm:mx-0 sm:w-auto sm:max-w-none"
              >
                Pirkt karti
              </a>
          ...
          <div className="hidden lg:flex w-full items-start">
            ...
            {/* Right column */}
            <div className="ml-auto min-w-[200px] text-right shrink-0">
              <h4 className="text-lg font-semibold mb-1 whitespace-nowrap">Dāvanu kartes</h4>
              <a
                href="/lv/davanu-kartes/"
                className="inline-flex justify-center w-[200px] px-5 py-2.5
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="#" className="text-white/70 hover:text-white transition-all duration-300" aria-label="Instagram" title="Instagram">
                <svg className="w-5 h-5 block" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.366.062 2.633.35 3.608 1.326.975.975 1.264 2.242 1.326 3.608.058 1.266.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.062 1.366-.35 2.633-1.326 3.608-.975.975-2.242 1.264-3.608 1.326-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-1.366-.062-2.633-.35-3.608-1.326-.975-.975-1.264-2.242-1.326-3.608C2.175 15.584 2.163 15.204 2.163 12s.012-3.584.07-4.85c.062-1.366.35-2.633 1.326-3.608C4.534 2.567 5.801 2.279 7.167 2.217 8.433 2.159 8.813 2.163 12 2.163zm0 1.622c-3.142 0-3.507.012-4.74.069-1.02.047-1.574.216-1.942.364-.489.19-.838.418-1.205.785-.367.367-.595.716-.785 1.205-.148.368-.317.922-.364 1.942-.057 1.233-.069 1.598-.069 4.74s.012 3.507.069 4.74c.047 1.02.216 1.574.364 1.942.19.489.418.838.785 1.205.367.367.716.595 1.205.785.368.148.922.317 1.942.364 1.233.057 1.598.069 4.74.069s3.507-.012 4.74-.069zm0 3.915a5.3 5.3 0 1 1 0 10.6 5.3 5.3 0 0 1 0-10.6zm0 1.8a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7zm5.7-2.047a1.237 1.237 0 1 1 0 2.475 1.237 1.237 0 0 1 0-2.475z" /></svg>
              </a>
