        ...
        <div className="py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:hidden">
            ...
            <div className="min-w-0">
              ...
              {/* Mobile: full width but limited by max-w */}
              <a
                href="/lv/davanu-kartes/"
                aria-label="Pirkt dāvanu karti"
                className="inline-flex w-full max-w-xs sm:w-auto sm:max-w-none justify-center
          ...
          <div className="hidden lg:flex w-full items-start">
            ...
            <div className="ml-auto min-w-[200px] text-right shrink-0">
              ...
              <a
                href="/lv/davanu-kartes/"
                aria-label="Pirkt dāvanu karti"
                className="inline-flex justify-center min-w-[180px] px-5 py-2.5
