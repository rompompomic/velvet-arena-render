    ...
    ["--shadow-sm" as any]: "0 1px 2px rgba(0,0,0,0.05)"
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch">
          {/* Иллюстрация */}
          <div className="w-full rounded-[12px] border bg-[var(--light)] shadow-sm overflow-hidden h-full lg:min-h-[360px]" style={{
          borderColor: "var(--neutral-200)"
        }}>
          ...
          <div className="w-full h-full" id="donate-form">
            <div className="bg-[var(--bg)] border rounded-[12px] p-6 lg:p-8 h-full lg:min-h-[360px]" style={{
            borderColor: "var(--neutral-200)",
            boxShadow: "var(--shadow-sm)"
          }}>
              {submitted ? <div className="text-center py-8">
                ...
                color: "var(--text)"
                  ...
                  color: "var(--text)"
                    ...
                    <input type="email" placeholder="E-pasts (rēķinam)" className="w-full h-10 px-3 rounded-md border text-sm" style={{
                  borderColor: "var(--neutral-200)",
                  color: "var(--text)"
                }} />
                  </div>
