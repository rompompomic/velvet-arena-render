        ...
        <div className="h-[calc(100vh-56px)] overflow-y-auto">
                ...
                <span key={l.code} className="flex items-center">
                  {l.active ? (
                    ...
                    <a
                      href={l.href}
                      onClick={() => setMobileOpen(false)}
                      className="text-text/80 hover:text-[hsl(var(--primary))] transition-colors link-underline"
                    >
                      {l.code}
                    </a>
                  )}
          ...
          <div className="px-4 pb-6">
            ...
            <div className="rounded-xl border border-neutral-200 p-3 flex items-center gap-3">
              <div className="w-14 h-12 rounded-lg border border-neutral-200 flex items-center justify-center text-xs text-text/60">
                LOGO
              </div>
              <div className="min-w-0">
                <div className="font-medium text-[15px] text-text/90">Main Sponsor</div>
                <div className="text-sm text-text/60">Atbalsta Latvian Horses</div>
              </div>
            </div>
          </div>
        </div>
