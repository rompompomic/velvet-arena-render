...
const SponsorsSection: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-[#f1f3f6] border-t border-neutral-200" aria-labelledby="sponsors-heading">
      <div className="container mx-auto px-4 max-w-7xl">
        {/* Title Block */}
        <div className="text-center mb-14 max-w-3xl mx-auto">
          <h2
            id="sponsors-heading"
            className="text-3xl md:text-4xl font-semibold tracking-tight text-text/90 mb-5"
          >
            Mūsu partneri
          </h2>
        ...
        <ul className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-8 gap-6 md:gap-7 mb-10" aria-label="Sponsor logos">
          {sponsors.map((sponsor, index) => (
            <li key={sponsor.name} className="group">
              <div
                className="relative rounded-2xl p-4 md:p-5 bg-white/70 backdrop-blur-sm ring-1 ring-black/5 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 overflow-hidden logo-appear"
        ...
        <div className="text-center">
          <p className="text-sm md:text-base text-muted-foreground">
            ...
            <a
              href="/lv/kontakti/"
              className="relative font-medium text-primary transition-colors duration-300 hover:text-primary-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
            >
              Sazinieties ar mums
