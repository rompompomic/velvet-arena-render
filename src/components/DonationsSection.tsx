          ...
          >
            <ul className="space-y-5">
              <li className="flex items-start gap-3">
                <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-[color:var(--primary)] text-white text-[12px] leading-none">
                  1
                </span>
                <div>
                  {/* H3 28/36 medium */}
              ...
              <form onSubmit={onSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {presets.map((p) => (
                      <button
                        ...
                        style={{
                          borderColor:
                            amount === p ? "var(--primary)" : "var(--neutral-200)",
                          background:
                            amount === p ? "color-mix(in oklab, var(--primary) 10%, transparent)" : "transparent",
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="h-[42px] w-36 rounded-lg px-3 pr-8 focus:outline-none"
                        style={{
                          border: "1px solid var(--neutral-200)",
                  ...
                  <div
                    ...
                    style={{ border: "1px solid var(--neutral-200)", borderRadius: 12 }}
                  >
                    <button
                      type="button"
                      onClick={() => setFreq("one")}
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      style={{
                        borderColor:
                          method === "card" ? "var(--primary)" : "var(--neutral-200)",
                        background:
                          method === "card" ? "var(--primary-50)" : "transparent",
                    ...
                    <button
                      ...
                      style={{
                        borderColor:
                          method === "bank" ? "var(--primary)" : "var(--neutral-200)",
                        background:
                          method === "bank" ? "var(--primary-50)" : "transparent",
                ...
                >
                  ...
                  {freq === "monthly" && (
                    <span className="ml-1 opacity-90">/ mēnesī</span>
                  )}
                </button>
