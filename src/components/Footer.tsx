            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                <a
                  ...
                  className="block px-4 py-2 bg-primary rounded-lg text-white hover:bg-primary-700 transition-colors duration-300 text-center font-medium"
                >
                  Pirkt karti
                </a>
              ...
              <nav className="space-y-2">
                {legalLinks.map((link) => (
                  <a
                    key={link.name}
                    href={link.href}
                    className="block text-sm text-white/70 hover:text-white/90 transition-colors duration-300"
                  >
                    {link.name}
                  </a>
                ))}
